      ...
      >
        ...
        <g id="body">
          ...
          <g id="leftArm" ref="leftArmRef">
            ...
            <path d="M32 382H18v-26h14z" class="cls-8"/>
          </g>
          <g id="torso">
            <path d="M263.3 467h-148l4-63c0-19.3 15.6-55 34.9-55h70.2c19.2 0 34.9 35.7 34.9 55l4 63Z" class="cls-2"/>
            <path d="M189.3 467.1v-95" class="cls-8"/>
            <path d="M192.3 361.1s16.9-6 29-19.3h23s-3.7 29.5-52 26.2v-6.9ZM186.2 361.1s-16.9-6-29-19.3h-23s3.7 29.5 52 26.2v-6.9Z" class="cls-2"/>
            <path d="M188.8 365.7s24-22.4 54.2 20.6c0 0-45 20.2-54.2-20.6Z" class="cls-6"/>
            <path d="M188.8 367.7s24-22.4 54.2 20.6c0 0-45 20.2-54.2-20.6Z" class="cls-8"/>
            <path d="M195.4 370s8.1 5 14.1 6" class="cls-8"/>
            <path d="M189.1 366s-19-26.6-57.2 9.6c0 0 40 28.6 57.2-9.5Z" class="cls-6"/>
            <path d="M191.1 366s-19-26.6-57.2 9.6c0 0 40 28.6 57.2-9.5Z" class="cls-8"/>
            <path d="M184 368s-4.5 2-11 2" class="cls-8"/>
            <rect width="11.8" height="14.4" x="183" y="359.4" class="cls-6" rx="5.9" ry="5.9"/>
            <rect width="11.8" height="14.4" x="184" y="359.4" class="cls-8" rx="5.9" ry="5.9"/>
        ...
        >
          ...
          <path d="M309.7 205s0 29.5-13 42.8c0 0 .8-50.1-17-75.7" class="cls-8"/>
          <path d="M320.3 283.9c7.5 4.8 13 12.7 13 12.7 7-33.5 38.6-249-141-249S43.6 262.6 50.7 296.2c0 0 5.5 21.8 11 33.2l5-32.3" class="cls-8"/>
          <path d="M325.2 258.7s-7.2 46.6-17.4 59c0 0 10.8-95.8-1.6-126.2M284.7 140s-.5 49-30.2 75c0 0 4-10.2.2-26" class="cls-8"/>
          <path d="M261.1 173.4s-7.8 31.3-37.6 47c0 0 7.7-20 7-31.7" class="cls-8"/>
          <path d="M243.7 173s-22 41.7-93 40.9c0 0 13.5-7.7 14-17.8M97.7 203s-26 103 0 175.6c0 0-30-39.4-35.5-116.4" class="cls-8"/>
          <path d="M111.3 203s-7.7 26-9.6 48c0 0-6-12-8-29" class="cls-8"/>
          <path d="M171.7 188.5s-11.9 21.8-64 28.7M178.4 312.6v1c0 4.1 4.9 7.4 10.9 7.4s10.8-3.3 10.8-7.3v-1.1" class="cls-8"/>
        ...
        <g id="hat">
          <path d="M330.6 65.2a28 28 0 0 0-15.7-38.3 28 28 0 0 0-37.4-17.5l-.2-.1a28 28 0 0 0-34 42.8l-10.7 23.1-.1.1c-1.8 3.8 10.8 13.5 28.2 21.6s32.8 11.5 34.6 7.7v-.1l10.8-23.1a28 28 0 0 0 24.5-16.2Z" style="fill:#fff"/>
          <path d="M296.5 87.7c-1.5.1-4.5-.1-10-1.6-6.7-1.8-15-5-23.3-8.8-17.5-8.2-27-15.5-29.5-18.8l-2.3 5c1.4 1.4 3.3 3 5.6 4.7 6 4.4 14.6 9.3 24 13.7s18.6 7.8 26 9.6a47 47 0 0 0 7.1 1.3l2.4-5Z" class="cls-6"/>
          <path d="M326.9 59a28 28 0 0 0-15.7-38.2 28 28 0 0 0-37.4-17.5l-.2-.2a28 28 0 0 0-34 42.8L228.8 69v.2c-1.8 3.8 10.8 13.4 28.1 21.5s32.8 11.6 34.6 7.8v-.2l10.8-23.1A28 28 0 0 0 327 59Z" class="cls-8"/>
        </g>
      </svg>
    </div>
  </div>
